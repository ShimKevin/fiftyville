...
SELECT people.name, atm_transactions.atm_transaction_type FROM people
...
FROM people
WHERE people_calls.caller = people.phone_number;
...
FROM airports
WHERE  flights.origin_airport_id = airports.city;
...
JOIN paseengers ON people.passport_number = passengers.passport_number
JOIN flights ON flights.id  = passengers.flight_id
